...
@section('title', 'SIMATA - Mahasiswa')
@section('content')
                            ...
                            <table id="datatable-buttons" class="table table-striped dt-responsive nowrap">
                                ...
                                <tbody>
                                    {{-- @foreach ($data as $item)
                                        <tr>
                                            <td><div class="form-check text-center"><input class="form-check-input checkbox" type="checkbox" value="{{ $item->id }}" id="flexCheckDefault"></div></td>
                                            <td>{{ $item->nama }}</td>
                                            <td>{{ $item->jenis_kelamin }}</td>
                                            <td>{{ $item->alamat }}</td>
                                            <td>{{ $item->tempat_lahir . ' ' . \Carbon\Carbon::parse($item->tanggal_lahir)->isoFormat('DD MMMM YYYY') }}</td>
                                            <td>{{ $item->no_tlpn }}</td>
                                            <td>{{ $item->prodi }}</td>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="AddDataLabel">Add Data Mahasiswa</h5>
                ...
                <form id="formAddData">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="nim" name="nim" value="{{ old('nim') }}" placeholder="1203210093">
                        ...
                        <div class="form-group">
                            ...
                            <input type="numeric" class="form-control" id="angkatan" name="angkatan" value="{{ old('angkatan') }}" placeholder="{{ date('Y') }}">
                            {{-- <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small> --}}
                        </div>
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                                ...
                                url: "{{ url('/admin/mahasiswa/destroy') }}",
                                type: "DELETE",
                                data: {
